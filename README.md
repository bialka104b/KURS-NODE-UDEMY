...
- `npm list` WYŚWIETLENIE LISTY GŁÓWNYCH ZAINSTALOWANYCH MODUŁÓW WRAZ ZALEŻNOŚCIAMI
- `npm list --depth 0` WYŚWIETLENIE LISTY GŁÓWNYCH ZAINSTALOWANYCH MODUŁÓW BEZ ICH ZALEŻNOŚCI
